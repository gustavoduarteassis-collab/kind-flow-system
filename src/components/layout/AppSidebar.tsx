...
import {
  Building2, DollarSign, Target, Users, FolderOpen, KeyRound, Home, Trash2, TrendingUp, LayoutGrid, CalendarCheck, Settings, ChevronDown, Store, LayoutDashboard,
} from "lucide-react";
import {
...
const mainItems = [
  { title: "Obras", url: "/obras", icon: LayoutDashboard },
