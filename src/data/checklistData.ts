...
export const checklistCategories: ChecklistCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 143, atividade: "Fita Sulço Simples Alumínio (verificar especificação no projeto)", responsavel: "Franqueado" },
      { id: 144, atividade: "Livro Procon", responsavel: "Franqueado" },
      { id: 145, atividade: "Divulgação da nova loja nas nossas redes sociais", responsavel: "Franqueado / Marketing" },
